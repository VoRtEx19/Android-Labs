...
import com.example.hw.fragments.Fragment1;
import com.example.hw.fragments.Fragment2;
import com.example.hw.fragments.Fragment3;
import com.example.hw.types.Type1;
import com.example.hw.types.Type2;
import com.example.hw.types.Type3;
        ...
        public void handleMessage(Message msg) {
            if (msg.what == 0) {
                ...
                if (round == 0) {
                    ...
                    dialog.show();
                    ok.setOnClickListener(ActivityPlay.this);
                } else if (round < 50) {
                    startRound();
                } else finish(1);
            }
